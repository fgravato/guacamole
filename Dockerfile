FROM bitnami/tomcat:10.0.10-debian-10-r19
...
RUN set -x \
  && curl -SLo /bitnami/tomcat/data/ROOT.war "http://apache.org/dyn/closer.cgi?action=download&filename=guacamole/${GUAC_VER}/binary/guacamole-${GUAC_VER}.war" \
